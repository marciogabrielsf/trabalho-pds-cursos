...
const TeacherCourseLearningPage: React.FC = () => {
    ...
    if (isLoading) {
        return (
            <div className="flex min-h-screen bg-gray-50">
                <TeacherSidebar activeItem="courses" onItemClick={() => {}} />
    ...
    const renderLessonContent = () => {
        ...
        if (!lessonData) {
            return (
                <div className="max-w-4xl">
                    ...
                    <p className="text-gray-600">
                        Escolha uma aula na barra lateral para visualizar o conteúdo em modo de
                        visualização.
                    </p>
                </div>
            );
        ...
        // Renderizar componente baseado no tipo da aula (sem funcionalidade de completar)
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            {lessonData && (
                <LessonAnalyticsModal
                    ...
                    moduleId={lessonData.moduleId?.toString() || ""}
                />
            )}
        </div>
    );
...
export default TeacherCourseLearningPage;
