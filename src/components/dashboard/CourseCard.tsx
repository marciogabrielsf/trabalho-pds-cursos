        ...
        >
            ...
            <div className="relative">
                <div className="w-full h-48 bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center">
                    {/* Placeholder da imagem - você pode substituir por uma imagem real */}
                ...
                {/* Badge da categoria */}
                <div
                    className={`absolute  top-3 left-3 px-3 py-2 rounded-md text-xs font-semibold text-white bg-gray-800`}
                >
                    {course.category}
                </div>
